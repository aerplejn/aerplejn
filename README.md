...
<h3> A passionate frontend developer</h3> <img align='right' src="https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExZzRseGMxcWNxOTZzc2IydWhuNGt4YWh1bmtucGV0ZWNsa215emtyaiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/9rRAZMcDBIi0AH9evw/giphy.gif" width="50"></h2>
  ...
  const aer = {
    ...
    technologies: {
        frontEnd: {
            ...
            uiLibraries: ["vscode", "Material UI", "Ant Design", "Chakra UI"],
